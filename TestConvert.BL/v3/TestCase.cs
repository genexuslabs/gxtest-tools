...
namespace GeneXus.GXtest.Tools.TestConvert.BL.v3
{
    ...
    public class TestCase
    {
        ...
        private readonly Dictionary<string, Element> elementsMap = new Dictionary<string, Element>();
        ...
        private readonly Dictionary<string, ParameterControlData> controlDataMap = new Dictionary<string, ParameterControlData>();
